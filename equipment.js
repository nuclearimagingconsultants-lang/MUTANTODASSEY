...
(function(root){'use strict';
 ...
 function bonuses(s,override){const e=override||s.odyssey?.equipment,out={punch:0,kick:0,defense:0,gift:0};for(const slot of slots){const id=e?.slots?.[slot],g=item(id);if(g&&g.slot===slot&&e.owned?.includes(id))for(const stat of Object.keys(out))out[stat]+=g[stat]||0}return out}
