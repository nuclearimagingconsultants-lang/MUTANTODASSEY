...
| Story | 24 titled acts with newly written connecting dialogue, a directed encounter per act, rewards, and next-chapter navigation. This is a compact reconstructed campaign, not the lost complete script. |
...
- No drivable cars, full building interiors, voiced NPCs, branching morality consequences, or 30 distinct authored side missions. Parked vehicles are scenery.
...
- The 24 acts use compact new scenes. Deep original story detail cannot be reconstructed exactly from titles alone.
...
- No public deployment or actual Chromebook-to-PC session was performed. Separate-client server recovery is covered by tests; phone layout was emulated in a browser.
