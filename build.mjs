...
const files=['index.html','odyssey.css','config.js','cesar-save.js','gift-roster.js','core.js','equipment.js','world-data.js','art.js','city-hd.js','battle-hd.js','campaign-data.js','adventure.js'];
...
const monsterAssets=['sentinel-hd.png','cast-hd.png','bestiary-hd.png'];
