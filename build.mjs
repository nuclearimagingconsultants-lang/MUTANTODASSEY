...
const files=['index.html','odyssey.css','config.js','cesar-save.js','gift-roster.js','core.js','world-data.js','art.js','city-hd.js','battle-hd.js','campaign-data.js','adventure.js'];
...
for(const file of [...files,'404.html','assets/ashford.png','assets/ashford-hd.png'])await copyFile(new URL(file,output),new URL(file,statics));
